          ...
          <div class="content-wrapper full-page-wrapper d-flex align-items-center auth login-bg">
            <div class="card col-lg-4 mx-auto">
              <div class="card-body px-5 py-5">
                ...
                <form method="POST" action= <?php echo Settings::RACINE."Game/Game_controller/verify_hascode"?>>
                  <div class="form-group">
                    <label>Hascode *</label>
                    <input type="text" placeholder="hascode" name="hascode" class="form-control p_input">
                  </div>
                  <div class="text-center">
                    <button type="submit" class="btn btn-success btn-block enter-btn">Play</button>
                  </div>
