                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex flex-row justify-content-between">
                      <h4><?php echo isset($utilisateur) && !$gameSearch? 'Mes parcours': 'Trouver une équipe'?></h4>
                      <p class="text-muted mb-1">Your data status</p>
                    </div>
                    <ul class="navbar-nav" >
                      <li class="nav-item">
                        <form class="nav-link mt-2 mt-md-0 d-lg-flex search">
                          <input type="text" id="searchbar" class="form-control" placeholder="chercher une équipe">
                        </form>
                      </li>
                    </ul>
                    <div class="row">
                      <div class="col-12" style="margin-bottom: 0; overflow: auto; height: 400px;">
                        <div class="preview-list" id="list">
                          <?php foreach($equipe_board as $value){
                                    echo '
                                        <div class="preview-item border-bottom">
                                            ...
                                            if(isset($equipe) && $gameSearch){
                                              ...
                                              <div class="me-auto text-sm-right pt-2 pt-sm-0">
                                                <button type="button" id='.$value->parcour->getCodeE().' class="btn btn-outline-primary btn-icon-text" style="margin-bottom: 3%;"><i class="mdi mdi-play btn-icon-prepend"></i>Jouer</button>
