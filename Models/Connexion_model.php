...
use \PDOException;
    ...
    class Connexion {
        ...
        private function __construct($db ='test2', $login ='root', $pass=''){ //$db ='fastadventure_cnam', $login ='271524', $pass='joseAimeLECN@N'
            $this->login = $login;
            $this->pass = $pass;
            $this->db = $db;
            $this->connexion();
        ...
        private function connexion(){
            ...
            {
                self::$connec = new PDO(
                        'mysql:host=localhost;dbname='.$this->db.';charset=utf8mb4', //'mysql:host=mysql-fastadventure.alwaysdata.net;dbname='.$this->db.';charset=utf8mb4', 
                                $this->login, 
                                $this->pass
                );
